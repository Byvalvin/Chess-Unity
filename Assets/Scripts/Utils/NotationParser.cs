...
public class NotationParser{
        ...
        PlayerState parsingPlayer;

        public NotationParser(PlayerState playerState){
            parsingPlayer = playerState;
        }

        public Vector2Int[] ParseMove(string move)
        {
        ...
        private Vector2Int[] HandleDisamiguationMove(string move){ // further processing
            ...
            foreach (PieceState piece in parsingPlayer.PieceStates){
