...
public class DragonState : EngineState
{
    ...
    private const string dragonPath = "C:/Users/cruzmart/Daniel/dragon/dragon_05e2a7/Windows/dragon-64bit-avx2"; // Change this to the actual Dragon executable path
